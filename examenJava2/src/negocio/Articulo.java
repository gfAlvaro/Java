...
public class Articulo {
    ...
    public Articulo( String descripcion , double precioCompra ,
    	    double precioVenta , int stock , int iva ) throws PrecioCompraNegativoException,
     ...
     */
    public void incrementar( int cantidad ) throws CantidadNegativaException, StockNegativoException {
     ...
     */
    public void reducir( int cantidad ) throws CantidadNegativaException, StockNegativoException { 
